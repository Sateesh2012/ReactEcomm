                            ...
                            return (
                                <tr key={index} className="text-orange-300">
                                    ...
                                    onClick={()=>navigate(`/updateProductPage/${id}`)}
                                     className="h-12 px-6 text-md transition duration-300 border-t border-l first:border-l-0 border-orange-100 
                                     stroke-slate-500 text-slate-500 text-green-500 cursor-pointer ">
                                        Edit
                                    </td>
                                    <td 
                                    onClick={()=>deleteProduct(id)}
                                    className="h-12 px-6 text-md transition duration-300 border-t border-l first:border-l-0 border-orange-100 stroke-slate-500 text-slate-500 text-red-500 cursor-pointer ">
                                        Delete
                                    </td>
                                </tr>
                            )
